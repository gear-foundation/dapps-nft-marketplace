...
const FT_STORAGE_WASM_PATH: &str = "./target/wasm32-unknown-unknown/debug/ft_storage.wasm";
const FT_LOGIC_WASM_PATH: &str = "./target/wasm32-unknown-unknown/debug/ft_logic.wasm";
const FT_MAIN_WASM_PATH: &str = "./target/wasm32-unknown-unknown/debug/ft_main.wasm";
